...
date: 2026-05-20
description: "複雑システム、高信頼性Backend、Infra、Embedded、LLM Integration、AI Workflow Automation に強みを持つシニアエンジニアの技術ポートフォリオ。"
layout: "simple"
---
...
23年の実務経験を持つシニアソフトウェアエンジニア／アーキテクトです。低レイヤ（C/C++）、ファームウェア、レガシー刷新、Infra、Embedded、高信頼性・分散バックエンドに加え、近年は AI Application、LLM Integration、AI Workflow Automation の実運用にも継続して取り組んでいます。
...
- **Infra / Distributed Systems**: Linux、deployment、observability、WebSocket / MQTT / Kafka、OAuth2 / JWT、安全性と可観測性を含む分散基盤。
- **Runtime Validation**: Zod などによる入力検証、E2E 自動化、ログ品質の維持、データ境界の保護。

---

### 3. AI / LLM Engineering Experience
...
### 4. AI-assisted Solution Design & Pre-sales Engineering
...
この種の作業は、通常は複数ロールの連携が必要ですが、条件が揃えば 1 日単位で、従来なら 1 〜 2 週間かかる pre-sales 技術提案と方案文書の初版をまとめられます。
...
重点は、低複雑度・高 ROI・短納期で成立する AI 工程化です。

---

### 5. AI-assisted Pre-sales & Solution Design
中小企業向けの AI 自動接待 / AI Workflow 方案を短期間で設計するケースです。

LLM、Workflow Automation、AI-assisted Engineering を使い、1 日内で以下をまとめました。
...
このケースが示しているのは、単なる API 呼び出しではなく、AI を使って solution design と pre-sales material を実際に前へ進める工程化能力です。

---

### 6. 実績・対応事例 / Proven Track Records
...
### 9. 対応スタイル / Engagement Preference
