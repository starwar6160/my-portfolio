...
- English technical communication is available

## Key Achievements

- 107億件規模の Elasticsearch / telemetry 基盤で、検索遅延を数秒台から **65-137ms** へ改善
- Spring Boot のデータ同期を **70秒 → 1.5秒** へ短縮
- Vue 3 + TypeScript の引き継ぎ直後フロントエンドで **74+ 件** の重大問題を安定化
- SD-WAN control plane の同期トラフィックを **約90%削減**
- SM9 / 低メモリ暗号実装で **10KB → 576B** までメモリフットプリントを圧縮

## About

20年以上運用されたシステム、高負荷バックエンド、分散システム、AI プラットフォームを対象に、性能改善、安定化、近代化を担当してきました。  
