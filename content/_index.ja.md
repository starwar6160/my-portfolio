...
hidemeta: true
comments: false
description: "技術担当者向けに、結果数字、複雑システム経験、AI Engineering、Backend、Reliability を簡潔に見せる日本語ホーム。"
disableShare: true
disableHLJS: false
---
...
複雑システム、性能改善、安定化、近代化を中心に、実務で何をやってきたかを短く整理しています。  
英語での技術コミュニケーションにも対応できます。
...
- [107億件 Elasticsearch / telemetry 基盤](/ja/cases/energy-cloud-governance/)
...
- [SM9 低レイヤ実装](/ja/projects/sm9-low-level/)
...
1. まず Key Achievements で、何をやり切ったかを示す
1. 次に 代表ケース で、詳細を自分で確認できるようにする
1. About で、何のタイプのエンジニアかを短く示す
1. 希望条件 で、受けたい領域を明示する
1. 技術スタック で、現実的な接続点を見せる
1. GitHub と 個人ホームページ で、補足情報へつなぐ
