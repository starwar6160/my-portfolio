...
### Protocol-Layer Systems Architect / Principal IC | 2021 – Present
- **Rescued Paralyzed HPUX Infrastructures**: Reverse-engineered undocumented data-link constraints in a zero-documentation environment.
...
- **Ultra-Low Latency IPC**: Delivered deterministic **200ns** inter-process latency via zero-copy shared memory.

### Senior Systems Architect | Goldwind | 2017 – 2019
- **Stabilized Global Grid Operations**: Cross-compiled and injected static Go binaries on-site to bypass corrupted OS network stacks.
- **Hyper-Scale I/O Rescue**: Resolved Elasticsearch collapse for 10.7B records via NVMe migration.

---

## PATENTS

- **Time-Deterministic Challenge-Response Protocol** (*CN107633588A*)
- **Dynamic Entropy Injection for Identity Verification** (*CN103530924B*)

---

## TECHNICAL SKILLS

- **Languages**: C/C++ (15+ yrs), Go, Python (Async/FastAPI), Assembly.
- **Domain**: Linux Kernel Tuning, eBPF, Cryptography (SM-series), Zero-copy IPC, Distributed Systems.
