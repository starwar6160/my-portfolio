...
- [OneKey ハードウェアウォレット・ファームウェア監査](/ja/cases/onekey-hardware-wallet-firmware-audit/): Medium 公開、CoinsBench 採用、ウォレット供給網分析、Secure Element 境界、乱数健全性、バイナリ検証。安全意識の高いシステム工程の実例として説明しやすい。
