...
- [AI Solution Engineering / Pre-sales](/ja/portfolio-ses/#ai-solution-engineering): AI Workflow、Solution Design、多言語提案、多バージョン文書生成。中小企業向けの短納期提案や AI 工程化、営業と技術の橋渡しに使いやすい。
